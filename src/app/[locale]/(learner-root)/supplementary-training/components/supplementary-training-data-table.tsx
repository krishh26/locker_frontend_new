...
export function SupplementaryTrainingDataTable() {
  ...
  const [selectedResource, setSelectedResource] = useState<SupplementaryTrainingResource | null>(null);
  ...
  const [trackResourceOpen, { isLoading: isTracking }] = useTrackSupTrainingResourceOpenMutation();
  ...
  const columns: ColumnDef<SupplementaryTrainingResource>[] = useMemo(
    () => [
      {
